...
import { ArrowRight, Github, Linkedin, MessageSquare, Brain, Zap } from "lucide-react"
...
export default function LandingPage({ onEnter }: LandingPageProps) {
  const socialLinks = [
    ...
    {
      name: "Email",
      url: process.env.NEXT_PUBLIC_EMAIL ? `mailto:${process.env.NEXT_PUBLIC_EMAIL}` : "",
      emoji: "✉️",
    },
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl font-bold tracking-tight leading-tight">
                <span className="bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent">VISTA</span>
              </h1>
              <p className="text-xl text-muted-foreground leading-relaxed">
                Vector-Integrated Semantic Text Assistant. Ask me anything about my projects, experience, and technical background.
              </p>
            </div>

            <div className="space-y-4">
              <p className="text-sm font-semibold text-foreground/70 uppercase tracking-wider">How it works</p>
              <div className="flex flex-wrap gap-3">
                <div className="glass-card px-4 py-2 text-sm font-medium">💬 Natural Questions</div>
                <div className="glass-card px-4 py-2 text-sm font-medium">📖 Sourced Answers</div>
                <div className="glass-card px-4 py-2 text-sm font-medium">⚡ Instant Responses</div>
              </div>
            </div>
            ...
            <div className="glass-card glass-shadow p-6 space-y-4 hover:bg-white/50 dark:hover:bg-white/10 transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Get detailed answers about my work, projects, and technical expertise.</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card glass-shadow p-6 space-y-4 hover:bg-white/50 dark:hover:bg-white/10 transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Every answer is sourced from my actual projects and experience.</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card glass-shadow p-6 space-y-4 hover:bg-white/50 dark:hover:bg-white/10 transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Get instant answers without waiting for a reply.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-16 border-t border-blue-200/30 dark:border-white/10">
        <div className="space-y-8">
          <div className="text-center space-y-3">
            ...
            <p className="text-muted-foreground">Find me on social media or reach out directly</p>
          </div>
